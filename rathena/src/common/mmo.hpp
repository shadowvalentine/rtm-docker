...
#define MAX_GUILD 51 + 3 * 3		 /// Increased max guild members +6 per 1 extension levels [Lupus]
...
struct s_storage
{
	...
	union
	{ // Max for inventory, storage, cart, and guild storage are 818 each without changing this struct and struct item [2016/08/14]
